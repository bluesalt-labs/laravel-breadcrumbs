...
namespace BlueSaltLabs\Breadcrumbs;
...
class BreadcrumbsManager
{
     ...
     * @return void
     * @throws \BlueSaltLabs\Breadcrumbs\Exceptions\DuplicateBreadcrumbException If the given name has already been
     *     used.
     */
     ...
     * @throws \BlueSaltLabs\Breadcrumbs\Exceptions\UnnamedRouteException if no name is given and the current route
     *     doesn't have an associated name.
     * @throws \BlueSaltLabs\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names
     *     are) not registered.
     */
     ...
     * @throws \BlueSaltLabs\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     * @throws \BlueSaltLabs\Breadcrumbs\Exceptions\UnnamedRouteException if no name is given and the current route doesn't have an associated name.
     * @throws \BlueSaltLabs\Breadcrumbs\Exceptions\ViewNotSetException if no view has been set.
     */
     ...
     * @throws \BlueSaltLabs\Breadcrumbs\Exceptions\UnnamedRouteException if the current route doesn't have an associated name.
     * @throws \BlueSaltLabs\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     */
