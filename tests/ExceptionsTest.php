...
class ExceptionsTest extends TestCase
{
    ...
    {
        $this->expectException(\BlueSaltLabs\Breadcrumbs\Exceptions\DuplicateBreadcrumbException::class);
    ...
    {
        $this->expectException(\BlueSaltLabs\Breadcrumbs\Exceptions\InvalidBreadcrumbException::class);
    ...
    {
        $this->expectException(\BlueSaltLabs\Breadcrumbs\Exceptions\ViewNotSetException::class);
